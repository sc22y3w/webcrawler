...
def test_crawl_enforces_minimum_politeness_window(monkeypatch):
    calls = []
    sleep_calls = []
    times = iter([0.0, 1.0, 1.0, 7.5, 7.5])
    ...
    pages = crawl("https://quotes.toscrape.com/one", max_pages=2, politeness_window=2.0, session=session)
